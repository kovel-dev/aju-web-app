...
import Heading from '../../components/form/section/heading'
import TextBox from '../../components/form/section/textbox'
            ...
            <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
              <div>
                <Heading
                  ...
                  subHeading="This information will be used to create account that can access the Portal."
                />
                <TextBox label="Email" id="email" name="email" width="1" />
                <TextBox
                  label="Confirm Email"
                  id="confirm-email"
                  name="confirm-email"
