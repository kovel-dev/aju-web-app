...
import TableView from '../../../components/partner-requests/table-view'

function ListOfPartnerReqViewPage() {
  return (
    <>
...
export default ListOfPartnerReqViewPage
