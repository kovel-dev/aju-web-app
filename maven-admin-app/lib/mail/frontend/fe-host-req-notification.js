export const FEHostReqNotification = (data) => {
  ...
  return {
    ...
    subject: 'Book a Speaker Submission Confirmation',
    text: `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<body style="max-width: 900px; margin: 0 auto;">
  <main style="border: 15px solid #E3E3E3;">
    <div style="padding: 50px 8%">
      ...
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Title: ${
        data.title
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Organization: ${
        data.organization
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Phone: ${
        data.phone
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Email: ${
        data.contact_email
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Contact By Phone?: ${
        data.prefer_phone ? 'Yes' : 'No'
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Date: ${
        data.date
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Type: ${
        data.type
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Location: ${
        data.location
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Speakers: ${speakers}</p>
