...
export const FEPartnerReqNotification = (data) => {
...
<body style="max-width: 900px; margin: 0 auto;">
  <main style="border: 15px solid #E3E3E3;">
    <div style="padding: 50px 8%">
      ...
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Add On: ${
        addOnTypes[data.add_on]
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Number of seats reserved: ${
        data.seats_reserved
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Details: ${
        data.details
      }</p>
      ...
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Requested Event: <a href="${
        data.link
      }" target="_blank">${data.event_name}</p>
