export const ForgotPasswordNotification = (data) => {
  return {
    from: `'"${process.env.NOTIFICATION_NAME}" <${process.env.NOTIFICATION_EMAIL}>'`,
    to: data.email,
    subject: 'Maven Forgot Password Request for ' + data.first_name,
    text: `
      <!DOCTYPE html>
      <html lang="en">
      <head>
      ...
      <body style="max-width: 900px; margin: 0 auto;">
        <main style="border: 15px solid #E3E3E3;">
          <div style="padding: 50px 8%">
            ...
            <div>
              <h1 style="text-align: center; font-size: 24px; border-top: 1px solid #979797; border-bottom: 1px solid #979797; color: #084E85; padding: 15px 0; margin: 40px auto; max-width: 460px;">Reset Your Password</h1>
            </div>
            <h2 style="color: #084E85; font-size: 20px; margin-top: 40px;">Hi ${data.first_name},</h2>
            <p style="color: #161D25; font-size: 16px; line-height: 30px;">Please click the link below to reset your password.</p>
            <div style="margin: 40px 0;">
              <a href="${process.env.NEXT_PUBLIC_FRONTEND_API_URL}/verify/reset-password/${data.reset_password_token}" target="_blank" style="background-color: #084E85; color: white; margin: 0 auto; text-decoration: none; padding: 34px 44px; font-weight: bold; display: block; width: 250px; font-size: 20px; text-align: center;">Reset Password Link</a>
            </div>
            <div style="margin: 40px 0;">
