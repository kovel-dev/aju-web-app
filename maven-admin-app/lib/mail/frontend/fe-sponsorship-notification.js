export const FESponsorshipNotification = (data) => {
  const tiers = {
  ...
  <main style="border: 15px solid #E3E3E3;">
    <div style="padding: 50px 8%">
      ...
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Contact By Phone?: ${
        data.method_of_contact_phone ? 'Yes' : 'No'
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Tier: ${
        tiers[data.tier]
      }</p>
      <p style="color: #161D25; font-size: 16px; line-height: 30px;">Message: ${
        data.details
      }</p>
